...
public class Level3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ppb.setFont(new java.awt.Font("Tempus Sans ITC", 1, 24)); // NOI18N
        ppb.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ppb.setBorder(null);
        getContentPane().add(ppb);
        ppb.setBounds(220, 160, 240, 40);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/AppPackage/android.png"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(0, -10, 670, 490);

        setSize(new java.awt.Dimension(662, 508));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void nextMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_nextMouseClicked
         if (ppb.getText().equals("PPB")){
